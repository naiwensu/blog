<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/home/wwwroot/default/blog/blog/public/../app/admin/view/index/index.html";i:1504426596;s:74:"/home/wwwroot/default/blog/blog/public/../app/admin/view/index/common.html";i:1504430073;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>苏苏的博客</title>
...
-->	
		...
		<?php if(is_array($article) || $article instanceof \think\Collection || $article instanceof \think\Paginator): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<div>
				...
				<p style="color: ">内容：<?php echo $vo['content']; ?></p>
                <p style="color: ">id：<?php echo $vo['id']; ?></p>
				<p>发表时间：20<?php echo date("y-m-d",$vo['create_time']); ?></p>
				<p><a href="__ROOT__/Articles/deletearticle?id=<?php echo $vo['id']; ?>">删除</a></p>
				<hr>
			</div>

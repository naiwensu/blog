...
-->	            	
		...
		<div class="col-sm-9 column" style="background:#BFBFBF">
			...
			<form class="form-horizontal" style="background: #BFBFBF"  action="__ROOT__/Users/doadduser" method="post" role="form">
			...
			$(function(){
				...
				$("#username").blur(function(){
					if(! $("#username").val().length>0 ){
						...
						$.get('__ROOT__/Users/check',{'username':username},function(data){
							if(data=='不允许'){
									$("#submit").attr("disabled","disabled");

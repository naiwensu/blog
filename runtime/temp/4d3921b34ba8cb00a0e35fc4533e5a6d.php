<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\phpStudy\WWW\blog\public/../app/admin\view\index\index.html";i:1501235778;s:63:"D:\phpStudy\WWW\blog\public/../app/admin\view\index\common.html";i:1502094078;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>苏苏的博客</title>
...
-->	            	
		...
		<?php if(is_array($article) || $article instanceof \think\Collection || $article instanceof \think\Paginator): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<div>
				...
				<p><a href="deletearticle?title=<?php echo $vo['title']; ?>">删除</a></p>
				<hr>
			</div>

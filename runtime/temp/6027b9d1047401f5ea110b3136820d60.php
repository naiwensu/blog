<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/home/wwwroot/default/blog/blog/public/../app/home/view/tags/getalltags.html";i:1504973389;s:73:"/home/wwwroot/default/blog/blog/public/../app/home/view/index/common.html";i:1505032361;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>苏苏的博客</title>
...
<body style="background: white;padding-left:0px;padding-bottom:;height: 100%">
	...
	<div align='center'>
		...
		<?php if(is_array($tags) || $tags instanceof \think\Collection || $tags instanceof \think\Paginator): $k = 0; $__LIST__ = $tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 3 );++$k;if($mod == '1'): ?><span style="font-size: 20px;color: red"><?php endif; ?>	
			<a style="color:black;text-decoration:underline;" href="__ROOT__/Articles/tagarticles?tag=<?php echo $vo['tag']; ?>"/><?php echo $vo['tag']; ?></a>
			<?php if($mod == '1'): ?></span><?php endif; ?>&nbsp;&nbsp;	
			<?php if($mod == '2'): ?><br/><?php endif; endforeach; endif; else: echo "" ;endif; ?>
			</div>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\phpStudy\WWW\blog\public/../app/admin\view\index\getallusers.html";i:1501135038;s:63:"D:\phpStudy\WWW\blog\public/../app/admin\view\index\common.html";i:1502107087;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>苏苏的博客</title>
...
-->	            	
		...
		<?php if(is_array($allusers) || $allusers instanceof \think\Collection || $allusers instanceof \think\Paginator): $i = 0; $__LIST__ = $allusers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<div>
				...
				<a href="getuserarticle?id=<?php echo $vo['id']; ?>"><?php echo $vo['username']; ?>的所有文章</a><br>

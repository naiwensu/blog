<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\phpStudy\WWW\blog\public/../app/admin\view\index\getuserarticle.html";i:1500649840;s:63:"D:\phpStudy\WWW\blog\public/../app/admin\view\index\common.html";i:1500642810;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>后台首页</title>
...
<body>
	...
	<div class="right">
		<?php if(is_array($userarticle) || $userarticle instanceof \think\Collection || $userarticle instanceof \think\Paginator): $i = 0; $__LIST__ = $userarticle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<div>
				<p style="color: red">标题：<?php echo $vo['title']; ?></p>
				<p style="color: red">标题：<?php echo $vo['content']; ?> <a href="deletearticle?title=<?php echo $vo['title']; ?>">删除</a></p>
				<hr>
			</div>

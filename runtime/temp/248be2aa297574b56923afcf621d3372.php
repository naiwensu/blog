<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/home/wwwroot/default/blog/blog/public/../app/home/view/user/setting.html";i:1504968987;s:73:"/home/wwwroot/default/blog/blog/public/../app/home/view/index/common.html";i:1504851097;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>苏苏的博客</title>
...
<div class="modal fade" id="changeheadimage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="formusername" action="__ROOT__/user/changeheadimage" enctype="multipart/form-data" method="post" role="form">
...
<div class="modal fade" id="changeusername" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="formusername" action="__ROOT__/user/changeusermessage" role="form" method="post">
	            <div class="modal-body">
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-9">
						    	<textarea class="form-control" id="introduction" name="introduction" rows="3" placeholder="请输入个人介绍"></textarea>
						    </div>
						</div>	
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-9">
						      	<input class="form-control" type="date" id="birthday" name="birthday" value="2017-9-9">
						    </div>
						</div>	
						<div class="form-group">
						...
						<div class="form-group">
						    <label for="address" class="col-sm-3 control-label">地区</label>
						    <div class="col-xs-3 col-sm-3">
						    	<select id="province" class="province form-control" name="province">
						    	</select>
					    	</div>
					    	<div class="col-xs-3 col-sm-3">
						    	<select id="city" class="city form-control" name="city">
						    	</select>
					    	</div>
					    	<div class="col-xs-3 col-sm-3">
						    	<select id="area" class="area form-control" name="area">
						    	</select>
						</div>	
				</div>
				<div class="modal-footer">

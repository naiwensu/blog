<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/home/wwwroot/default/blog/blog/public/../app/admin/view/login/login.html";i:1504410792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>登录页面</title>
...
<div style="background:#fff ;margin-right: 0px; padding-left:;padding-right: ; padding-top: 150px;padding-bottom:">
	<div class="container" >
					...
					<form class="form-horizontal" style="background: " action="dologin" method="post" role="form">
						...
						<label for="name" class="col-sm-offset-5"><h1>后台登录</h1></label>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/home/wwwroot/default/blog/blog/public/../app/home/view/user/mycollection.html";i:1504950548;s:73:"/home/wwwroot/default/blog/blog/public/../app/home/view/index/common.html";i:1504851097;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>苏苏的博客</title>
...
<body style="background: white;padding-left:0px;padding-bottom:;height: 100%">
	...
	<div class="row clearfix">
		...
		<?php if(is_array($collection) || $collection instanceof \think\Collection || $collection instanceof \think\Paginator): $i = 0; $__LIST__ = $collection;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<div>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/home/wwwroot/default/blog/blog/public/../app/admin/view/group/groupauthorization.html";i:1502376042;s:74:"/home/wwwroot/default/blog/blog/public/../app/admin/view/index/common.html";i:1504416860;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>苏苏的博客</title>
...
-->	
	...
	<div class="row clearfix">
		<div class="col-sm-offset-10 col-sm-2 ">
			<a class="btn" href="__ROOT__/Group/addgroup"><span class="glyphicon glyphicon-plus"></span> 添加组</a>
		</div>
	</div>
	<div class="row clearfix">
		<div class="col-sm-offset-1 col-sm-10 ">
			...
			<table class="table table-bordered"  >
				  ...
				  <tbody>
					<?php if(is_array($groups) || $groups instanceof \think\Collection || $groups instanceof \think\Paginator): $key = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;if($vo['id']=='1'): ?>
						<tr>
							<td align="center"><?php echo $key; ?></td>
							<td align="center"><?php echo $vo['groupname']; ?></td>
							<td colspan="3" align="center"><a href="__ROOT__/Group/updatesuperauthorization?id=<?php echo $vo['id']; ?>">修改</a></td>
						</tr>
						<?php else: ?>			
						<tr>
							<td align="center"><?php echo $key; ?></td>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/home/wwwroot/default/blog/blog/public/../app/home/view/user/mymessage.html";i:1504958976;s:73:"/home/wwwroot/default/blog/blog/public/../app/home/view/index/common.html";i:1505032361;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>苏苏的博客</title>
...
<body style="background: white;padding-left:0px;padding-bottom:;height: 100%">
	...
	<h4><image src="__ROOT__/static/image/username.png" style="width:23px;height: 23px" />&nbsp;&nbsp;<a href="__ROOT__/user/mymessages"><?php echo $user['username']; ?></a></h4>
	<h4><a href="__ROOT__/user/mycollection?id=<?php echo $user['id']; ?>"><image src="__ROOT__/static/image/collect.png" style="width:23px;height: 23px" />&nbsp;&nbsp;我的收藏</a></h4>
	<h4><a href="__ROOT__/user/mycomment?id=<?php echo $user['id']; ?>"><image src="__ROOT__/static/image/comment.png" style="width:23px;height: 23px" />&nbsp;&nbsp;我的评论</a></h4>	
	<h4><image src="__ROOT__/static/image/setting.png" style="width:23px;height: 23px" />&nbsp;&nbsp;<a href="__ROOT__/user/setting">编辑资料</a></h4>	

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\phpStudy\WWW\blog\public/../app/admin\view\index\getallgroupusers.html";i:1501586753;s:63:"D:\phpStudy\WWW\blog\public/../app/admin\view\index\common.html";i:1501589549;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>苏苏的博客</title>
			...
			<div style="background: #BFBFBF">
				<ul class="nav nav-pills nav-stacked">
					<li class="active"><a href="index"><span class="glyphicon glyphicon-home"></span>首&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;页</a></li>
				  	...
				  	<li><a href="publish"><span class="glyphicon glyphicon-upload"></span>发表文章</a></li>
				  	<li><a href="edit"><span class="glyphicon glyphicon-edit"></span>编辑文章</a></li>
<!--					<li class="dropdown">
...
-->	            	
					...
					<ul id="ceshi" id="collapseThree" class="nav panel-collapse collapse">
		                    <li><a href="__ROOT__/admin/Index/adduser"><span class="glyphicon glyphicon-plus-sign"></span> 添加用户</a></li>
		                    <li><a href="__ROOT__/admin/Index/getallusers"><span class="glyphicon glyphicon-trash"></span> 删除用户</a></li>
					</ul>
					...
					<ul id="quanxian" class="nav panel-collapse collapse">
		                    <li><a href="__ROOT__/admin/Group/getallgroupusers"><span class="glyphicon glyphicon-exclamation-sign"></span> 用户权限</a></li>
		                    <li><a href="__ROOT__/admin/Group/getallgroupusers"><span class="glyphicon glyphicon-exclamation-sign"></span> 组&nbsp;&nbsp;权&nbsp;&nbsp;限</a></li>
					</ul>
				</ul>
			</div>
		...
		<?php if(is_array($allusers) || $allusers instanceof \think\Collection || $allusers instanceof \think\Paginator): $i = 0; $__LIST__ = $allusers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<div>
				...
				<a href="__ROOT__/admin/Group/changegroup">用户组</a>
			</div>

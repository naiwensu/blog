<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"D:\phpStudy\WWW\blog\public/../app/admin\view\index\doedit.html";i:1501410433;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>提交编辑</title>
		...
		<div class="col-sm-12 column" >
			...
			<form class="form-horizontal" style="background: ;"  action="update?id=<?php echo $article['id']; ?>" method="post" role="form">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-6">
			        <!-- 加载编辑器的容器 -->
			        <script id="container" name="content" type="text/plain"> <?php echo $article['content']; ?>        
			        </script>
				    <!-- 配置文件 -->

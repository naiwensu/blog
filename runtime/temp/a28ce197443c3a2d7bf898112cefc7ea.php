<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/home/wwwroot/default/blog/blog/public/../app/admin/view/group/authorization.html";i:1504428206;s:74:"/home/wwwroot/default/blog/blog/public/../app/admin/view/index/common.html";i:1504416860;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>苏苏的博客</title>
...
-->	
	...
	<div class="row clearfix">
		<form class="form-horizontal" style="background: #f5f5f5"  action="__ROOT__/Group/updaterole" method="post" role="form">			
			...
			<?php if(is_array($aut) || $aut instanceof \think\Collection || $aut instanceof \think\Paginator): $i = 0; $__LIST__ = $aut;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>		
				...
				<input type="hidden" name="role[<?php echo $key; ?>][gid]" value=<?php echo $gid; ?>>

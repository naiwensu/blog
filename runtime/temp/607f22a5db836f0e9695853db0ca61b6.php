<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/home/wwwroot/default/blog/blog/public/../app/home/view/user/mycomment.html";i:1504950807;s:73:"/home/wwwroot/default/blog/blog/public/../app/home/view/index/common.html";i:1504851097;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>苏苏的博客</title>
...
<body style="background: white;padding-left:0px;padding-bottom:;height: 100%">
	...
	<?php if(is_array($comment) || $comment instanceof \think\Collection || $comment instanceof \think\Paginator): $i = 0; $__LIST__ = $comment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['headimage'] != ''): ?>
			<image style='width: 60px;height: 60px;float: left' src="__ROOT__/static/headimage/<?php echo $vo['headimage']; ?>" alt='头像' />
			<?php else: ?>
			<image style='width: 60px;height: 60px;float: left' src="__ROOT__/static/default/0.jpg" alt='头像' />
			<?php endif; ?>
			<div style='height: 60px;'>
				<div style='position: relative;top: 30%'>
					<b>&nbsp;&nbsp;<?php echo $vo['username']; ?>	</b><br>	
					<small>&nbsp;&nbsp;发表于<?php echo date('Y-m-d',$vo['c_create_time']); ?></small><br>
				</div>
			</div>
		评论内容：<?php echo $vo['c_content']; ?><br>
		<p><a href="__ROOT__/comment/delcomment?id=<?php echo $vo['c_id']; ?>">删除</a></p>
		<div style="background: #EAECEE;padding:15px">
		<h4>文章标题：<?php echo $vo['title']; ?></h4><br>
		文章内容：&nbsp;&nbsp;&nbsp;&nbsp;<?php echo substr(trim($vo['content']),0,6); ?>... ...<br>		
		发表于 <?php echo date('Y-m-d',$vo['create_time']); ?> |
		评论(<?php echo $vo['cnum']; ?>) |
		读数(<?php echo $vo['rnum']; ?>)<br>
		</div>
